...
__help__ = """
 - /setbio <text>: ao responder, salvará a biografia de outro usuário
 - /bio: obterá a sua biografia ou a de outro usuário. Isso não pode ser definido por você.
 - /setme <text>: irá definir suas informações
 - /me: obterá informações suas ou de outro usuário
"""

__mod_name__ = "ðŸ§¾ Bios e Abouts ðŸ§¾"
