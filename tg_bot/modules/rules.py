...
def set_rules(bot: Bot, update: Update):
    ...
    if len(args) == 2:
        ...
        update.effective_message.reply_text("Regras definidas com sucesso para este grupo.")
...
def clear_rules(bot: Bot, update: Update):
    ...
    update.effective_message.reply_text("Regras apagadas com sucesso!")


def __stats__():
    return "{} os bate-papos t�m regras definidas.".format(sql.num_chats())
...
__help__ = """
 - /rules: obter as regras para este bate-papo.

*Admin only:*
 - /setrules <suas regras aqui>: defina as regras para este bate-papo.
