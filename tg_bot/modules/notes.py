...
def __stats__():
    return "{} notas, através {} chats.".format(sql.num_notes(), sql.num_chats())
...
def __chat_settings__(chat_id, user_id):
    ...
    return "Existem `{}` notas neste chat.".format(len(notes))
...
Se você gostaria de recuperar o conteúdo de uma nota sem qualquer formatação, use `/get <notename> noformato`. Isso pode \
ser útil ao atualizar uma nota atual.

*Apenas administrador:*
 - /save <notename> <notedata>: salva notados como uma nota com o nome notename
Um botão pode ser adicionado a uma nota usando a sintaxe de link markdown padrão - o link deve ser adicionado antes de um \
`buttonurl: seção `, como tal: `[somelink](buttonurl:example.com)`. Verificar /markdownhelp para mais informações.
 - /save <notename>: salve a mensagem respondida como uma nota com o nome notename
 - /clear <notename>: nota clara com este nome
"""

__mod_name__ = "🗒️ Notas 🗒️"
