...
*Apenas administrador:*
 - /welcome <on/off>: habilitar desabilitar mensagens de boas-vindas.
 - /welcome: mostra as configurações de boas-vindas atuais.
 ...
 - /goodbye -> mesmo uso e argumentos que / welcome.
 - /setwelcome <sometext>: definir uma mensagem de boas-vindas personalizada. Se usado para responder à mídia, usa essa mídia.
 - /setgoodbye <sometext>: definir uma mensagem de adeus personalizada. Se usado para responder à mídia, usa essa mídia.
 - /resetwelcome: redefinir para a mensagem de boas-vindas padrão.
 - /resetgoodbye: redefinir para a mensagem de adeus padrão.
 - /cleanwelcome <on/off>: No novo membro, tente excluir a mensagem de boas-vindas anterior para evitar spam no chat.
 - /clearjoin <on/off>: quando alguém entrar, tente excluir o *usuário* que entrou na mensagem do grupo.
