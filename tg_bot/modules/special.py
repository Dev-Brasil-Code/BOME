...
__help__ = """
**Dono apenas:**
- /getlink **chatid**: Obtenha o link de convite para um bate-papo específico.
- /banall: Banir todos os membros de um chat
- /leavechat **chatid** : deixe um bate-papo
**Sudo/owner only:**
- /quickscope **userid** **chatid**: Banir o usuário do chat.
- /quickunban **userid** **chatid**: Desbanir usuário do bate-papo.
- /snipe **chatid** **string**: Faça-me enviar uma mensagem para um bate-papo específico.
- /rban **userid** **chatid** banir remotamente um usuário de um bate-papo
- /runban **userid** **chatid** desbanir remotamente um usuário de um bate-papo
- /Stats: verifique as estatísticas do bot
- /chatlist: obter lista de bate-papo
- /gbanlist: obter lista de usuários gbanned
- /gmutelist: obter lista de usuários gmuted
- Bate-papo banidos por meio dos comandos / restringir chat_id e / unrestrict chat_id
**Usuário de suporte:**
- /Gban : Banir um usuário globalmente
- /Ungban : Ungban um usuário
- /Gmute : Silenciar um usuário
- /Ungmute : Desativar o som de um usuário
Sudo/owner também pode usar esses comandos.
**Comercial:**
- /listsudo Dá uma lista de usuários sudo
- /listsupport fornece uma lista de usuários de suporte
"""
__mod_name__ = "ðŸª† Especial ðŸª†"
