...
def __chat_settings__(chat_id, user_id):
    ...
    return "Existem `{}` filtros personalizados aqui.".format(len(cust_filters))


__help__ = """
 - /filters: liste todos os filtros ativos neste chat.

*Admin only:*
 - /filter <palavra-chave> <responder à mensagem>: adicione um filtro a este chat. O bot agora responderá essa mensagem sempre que 'palavra-chave' \
é mencionado. Se você responder a um adesivo com uma palavra-chave, o bot responderá com esse adesivo. NOTA: todos os filtros \
palavras-chave estão em minúsculas. Se você quiser que sua palavra-chave seja uma frase, use aspas. por exemplo: /filter "ei" Como você \
fazendo?
 - /stop <filtrar palavra-chave>: pare esse filtro.
"""
