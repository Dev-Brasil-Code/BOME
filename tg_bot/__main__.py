...
Se você tiver alguma dúvida sobre como me usar, por favor me dê /help.....
...
Vá para o canal Meu telegrama e inscreva-se ----> @HCnetibrtelemar

Grupo de suporte 💙 @ClaynetChat

Obrigada !!!!!

Para mais comandos clique /help...

** Para usar este bot deixe pelo menos o crédito para o criador **
...
*Principal* comandos disponíveis:
 - /start: Inicie o bot...
 - /help: Ajuda....
 - /donate: Para saber mais sobre doações!
 - /settings:
   - in PM: Para descobrir quais configurações você definiu....
   - in a group:
...
DONATE_STRING = """Ei, fico feliz em saber que você quer doar!
Demorou muito para [meu criador] (t.me/AdmClaynet) chegar onde estou agora, e cada doação ajuda \
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Até que enfim mais grupo")
...
def error_callback(bot, update, error):
    try:
        ...
        print("no nono3")
        # lidar com problemas de conexão lenta
    except NetworkError:
        print("no nono4")
...
def help_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            text = "Aqui está a ajuda para o *{}* Comanndo:\n".format(HELPABLE[module].__mod_name__) \
        ...
        if excp.message == "A mensagem não foi modificada":
            pass
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contate-me no PM para obter a lista de comandos possíveis.",
                                            reply_markup=InlineKeyboardMarkup(
        ...
        module = args[1].lower()
        text = "Aqui está a ajuda disponível para o *{}* Comando:\n".format(HELPABLE[module].__mod_name__) \
               + HELPABLE[module].__help__
...
def send_settings(chat_id, user_id, user=False):
    if user:
        ...
        if CHAT_SETTINGS:
            ...
            dispatcher.bot.send_message(user_id, "Parece que não há configurações de bate-papo disponíveis :'(\nMande isso "
...
def settings_button(bot: Bot, update: Update):
    ...
    try:
        if mod_match:
            ...
            text = "*{}* tem as seguintes configurações para o *{}* Comando:\n\n".format(escape_markdown(chat.title),
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 917233784 and DONATION_LINK:
            update.effective_message.reply_text("Você também pode fazer uma doação para a pessoa que está atualmente me administrando "
        ...
        try:
            ...
            update.effective_message.reply_text("Contate-me primeiro no PM para obter informações sobre doações.")
